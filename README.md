...
Firebase hosting offer a way to host web page.<br/><br/><br/>
...
I used `Github actions` in order to automate the deployment of the web app on firebase.<br/><br/><br/><br/>
