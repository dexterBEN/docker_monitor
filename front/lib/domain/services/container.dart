...
class ContainerService {
  ...
  Future fetchAllContainer() async {
    final response = await http
        .get(Uri.parse("https://a109-88-170-147-136.ngrok.io/containers"));
  ...
  Future createImage(DroppedFile droppedFile) async {
    var request = http.MultipartRequest(
      "POST",
      Uri.parse("https://a109-88-170-147-136.ngrok.io/container/images"),
    );
  ...
  void restartContainer(String containerID) async {
    ...
    final response = await http.post(
      Uri.parse(
        "https://a109-88-170-147-136.ngrok.io/docker-monitor/container/restart/$containerID",
      ),
    );
  }
  ...
  void stopContainer(String containerID) async {
    final response = await http.post(
      Uri.parse(
        "https://a109-88-170-147-136.ngrok.io/docker-monitor/container/stop/$containerID",
      ),
    );
  }
}
